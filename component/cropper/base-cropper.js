...
export const EMPTY_IMAGE = './image/empty.png' // 'https://test.qtrade.com.cn/image/empty.png' // './image/empty.png'
const extensionList = ['.jpg', '.jpeg', '.png']

export default class BaseCropper extends React.Component {
	constructor (props) {
		super(props)
		...
		return (
			<div className='cropper-component'>
				<div className='body-container'>
					<div className='cropper-content' style={{width: this.props.width + 'px', height: this.props.height + 'px'}}>
						<Cropper
