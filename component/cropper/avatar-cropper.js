...
import BaseCropper from './base-cropper'
import VerticalPosition from '../popup/vertical-position'
import StringUtil from '../../util/string-utils'
...
export default class AvatarCropper extends React.Component {
	...
	doChange () {
		...
		if (StringUtil.isNullOrEmpty(this.state.avatarSrc)) {
			PopupService.showUniqueCustom({
				ui: <BaseCropper onSubmit={_this.updateAvatarSrc} onCancel={_this.doCancel} />,
	...
	render () {
		return (
			<div className='avatar-cropper-component'>
